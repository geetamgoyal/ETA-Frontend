...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'nav.live_network': 'Live Train Tracking',
    'nav.eta_forecast': 'AI ETA Forecast',
    'nav.route_predictions': 'Route Predictions',
    'nav.alerts': 'Alerts',
    'nav.analytics': 'Analytics',
    'nav.historical_performance': 'Historical Performance',
    ...
    'desc.historical_performance': 'Previous journeys, recurring delays, corridor bottlenecks & prediction accuracy',
  ...
  hi: {
    ...
    'nav.live_network': 'लाइव ट्रेन ट्रैकिंग',
    'nav.eta_forecast': 'AI ईटीए पूर्वानुमान',
    'nav.route_predictions': 'मार्ग भविष्यवाणी',
    'nav.alerts': 'अलर्ट्स',
    'nav.analytics': 'एनालिटिक्स',
    'nav.historical_performance': 'ऐतिहासिक प्रदर्शन',
    ...
    'desc.historical_performance': 'पिछली यात्राएं, आवर्ती देरी, कॉरिडोर बाधाएं और भविष्यवाणी सटीकता',
