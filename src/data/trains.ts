...
export const MOCK_TRAINS: Train[] = [
  ...
  },
  {
    ...
    expectedEtaRange: { min: '14:15', max: '14:25' },
    factors: {
  ...
  },
  {
    ...
    expectedEtaRange: { min: '13:15', max: '13:25' },
    factors: {
    ...
    stations: [
      ...
      },
      {
        ...
        scheduledDeparture: '-',
        actualOrPredictedArrival: '13:20',
        predictedDelayMinutes: 45,
        confidence: 85,
        status: 'Destination',
      },
  ...
  },
  {
    ...
    expectedEtaRange: { min: '14:05', max: '14:12' },
    stations: [
      {
        stationCode: 'NDLS',
        stationName: 'New Delhi',
    ...
    etaHistory: makeHistory('14:00', 8, false),
    lastUpdatedAt: new Date().toISOString(),
    recentEvents: [
  ...
  },
  {
    ...
    expectedEtaRange: { min: '06:15', max: '06:25' },
    stations: [
      {
        stationCode: 'NDLS',
        stationName: 'New Delhi',
    ...
    etaHistory: makeHistory('06:20', 0, false),
    lastUpdatedAt: new Date().toISOString(),
    recentEvents: [
